...
module.exports.bundleIdentifiers = function (currentAppName, newName, projectName, currentBundleID, newBundleID, newBundlePath) {
  ...
  return [
    ...
    },
    {
      regex: currentBundleID,
      replacement: newBundleID,
      paths: [path.join('ios', `${noSpaceNewName}.xcodeproj`, 'project.pbxproj')]
    }
  ];
};
